...
// Allow `npm run seed` (force reseed). pathToFileURL makes this work cross-platform
// (on Windows, argv[1] is a backslash path that never equals a file:// URL directly).
