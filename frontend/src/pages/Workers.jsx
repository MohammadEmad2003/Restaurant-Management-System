...
import { Plus, UserX, Shield, User, ChefHat, Pencil, Wallet, Clock } from 'lucide-react';
    ...
    <div className="fade-in">
      ...
      <Modal open={!!detail} onClose={() => setDetail(null)} wide
        ...
        {detail && (<>
          ...
          <div className="card__title row" style={{ gap: 8, marginBottom: 8 }}><Clock size={16} /> {t('attendance.title', 'Attendance')}</div>
          <DataTable
            columns={[
